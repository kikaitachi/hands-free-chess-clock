...
const int BLINK_RATE_NOBLINK = 0b00;
const int BLINK_RATE_2HZ = 0b01;
const int BLINK_RATE_1HZ = 0b10;
const int BLINK_RATE_0_5HZ = 0b11;
...
class Display {
 public:
  ...
  void blink_white(int rate);
  void blink_black(int rate);

 private:
  int fd;
  uint8_t mem[16 * 2];

  void blink(int address, int rate);
